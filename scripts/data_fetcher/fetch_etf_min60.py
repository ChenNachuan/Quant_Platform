# -*- coding: utf-8 -*-
"""
ETF 60分钟K线数据增量拉取（按月获取，避免 OOM）

docker-compose run --rm amazingdata python3 /scripts/data_fetcher/fetch_etf_min60.py
"""
...
ETF_DATA_DIR = Path("/data/etf/market_data/min60")
