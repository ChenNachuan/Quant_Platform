...
docker-compose run --rm amazingdata python3 /scripts/data_fetcher/fetch_future_min60.py
"""
...
FUTURE_DATA_DIR = Path("/data/future/market_data/60min")
FAILED_CODES_DIR = FUTURE_DATA_DIR / "failed_codes"
